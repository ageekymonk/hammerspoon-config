...
winmgmtbase_keys = {"cmd", "ctrl", "alt"}

local function module_init()
  hs.hotkey.bind(winmgmtbase_keys, "down", function ()
                   pressed.down = true
                   if pressed.up then
                     fullDimension('h')
                   else
  ...
  hs.hotkey.bind(winmgmtbase_keys, "right", function ()
                   pressed.right = true
  ...
  hs.hotkey.bind(winmgmtbase_keys, "left", function ()
                   pressed.left = true
  ...
  hs.hotkey.bind(winmgmtbase_keys, "up", function ()
                   pressed.up = true
  ...
  hs.hotkey.bind(winmgmtbase_keys, "f", function ()
                   nextFullScreenStep()
  end)

  hs.hotkey.bind(winmgmtbase_keys, "i", function ()
                   local win = hs.window.frontmostWindow()
                   local id = win:id()
                   local screen = win:screen()
                   cell = hs.grid.get(win, screen)
